...
async function writeGptStatus(_0x3732a0) {
  try {
    await _0x34477e.writeFile(gptStatusFile, JSON.stringify({
      'enabled': _0x3732a0
    }, null, 0x2));
  } catch (_0x5d47bd) {
...
async function writeChatHistory(_0x4e1596) {
  try {
    await _0x34477e.writeFile(chatHistoryFile, JSON.stringify(_0x4e1596, null, 0x2));
  } catch (_0x302a6c) {
...
async function updateChatHistory(_0x42f5cb, _0x518f27, _0x275808) {
  ...
  if (_0x42f5cb[_0x518f27].length > 0x14) {
...
const deepseek = async (_0xb1ff4a, _0xc5b8ec) => {
  ...
  if (_0x313ed8 === "gpt1 on" || _0x313ed8 === "gpt1 off") {
    ...
    const _0x5781fd = _0x313ed8 === "gpt on";
  ...
  try {
    ...
    if (!_0xc04951.ok) {
      throw new Error("HTTP error! status: " + _0xc04951.status);
    }
    const _0x388774 = await _0xc04951.json();
    const _0x39f6a9 = _0x388774.data;
    await updateChatHistory(_0x3abcfa, _0xb1ff4a.sender, {
      'role': "user",
      'content': _0x313ed8
    });
    await updateChatHistory(_0x3abcfa, _0xb1ff4a.sender, {
